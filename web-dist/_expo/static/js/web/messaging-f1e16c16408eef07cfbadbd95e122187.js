__d(function(g,r,i,a,m,_e,d){"use strict";Object.defineProperty(_e,'__esModule',{value:!0}),_e.registerWebPushToken=async function(){if(!await(0,e.isSupported)().catch(()=>!1))return{ok:!1};return console.warn("EXPO_PUBLIC_FCM_VAPID_KEY ausente. Pulei web push."),{ok:!1}};r(d[0]),r(d[1]);var e=r(d[2])},1068,[736,2300,2340]);
__d(function(g,r,i,a,m,e,d){"use strict";Object.defineProperty(e,'__esModule',{value:!0});var t=r(d[0]);Object.keys(t).forEach(function(n){'default'===n||Object.prototype.hasOwnProperty.call(e,n)||Object.defineProperty(e,n,{enumerable:!0,get:function(){return t[n]}})})},2340,[2341]);
