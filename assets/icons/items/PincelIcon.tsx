...
type PincelIconProps = React.ComponentProps<typeof Svg> & {
  size?: number;
};

export function PincelIcon({ size = 96, ...rest }: PincelIconProps) {
  ...
  return (
    <Svg viewBox="0 0 32 32" width={width} height={height} fill="none" {...rest}>
      <Rect x="6.5" y="21.5" width="17" height="10" fill="#FFFAEE" stroke={strokeColor} />
      <Path
        d="M7,25.5H6.5v6h17v-5H23c-0.827,0-1.5,0.673-1.5,1.5s-0.673,1.5-1.5,1.5h-1
      ...
      />
      <Path
        d="M5.5,21.5h19V19c0-1.378-1.122-2.5-2.5-2.5h-5.532l0.846-13.537
      ...
      />
      <Path
        d="M25,19c0-1.657-1.343-3-3-3h-5l0.813-13.006C17.914,1.372,16.626,0,15,0
