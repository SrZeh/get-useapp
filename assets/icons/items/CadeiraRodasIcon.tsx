...
type CadeiraRodasIconProps = React.ComponentProps<typeof Svg> & {
  size?: number;
};

export function CadeiraRodasIcon({ size = 96, ...rest }: CadeiraRodasIconProps) {
  const width = rest.width ?? size;
  const height = rest.height ?? size;

  return (
    <Svg viewBox="0 0 1024 1024" width={width} height={height} {...rest}>
      <G>
        <Path
