...
type LunetaIconProps = React.ComponentProps<typeof Svg> & {
  size?: number;
};

export function LunetaIcon({ size = 96, ...rest }: LunetaIconProps) {
  const width = rest.width ?? size;
  const height = rest.height ?? size;

  return (
    <Svg viewBox="0 0 472.457 472.457" width={width} height={height} fill="none" {...rest}>
      <G>
        <G>
          <G>
            <Path
              d="M435.991,179.488c21.86,10.16,36.22,32.33,36.22,56.74c0,24.41-14.36,46.58-36.22,56.74v2.98
            ...
            />
            <Path
              d="M435.991,196.638c13.01,8.69,21.22,23.5,21.22,39.59s-8.21,30.9-21.22,39.59V196.638z"
              fill="#86A9F7"
            />
            <Path
              d="M420.991,184.018v104.43h-45.92v-104.43H420.991z M417.331,196.228c0-4.15-3.35-7.5-7.5-7.5
				h-23.61c-4.14,0-7.5,3.35-7.5,7.5c0,4.14,3.36,7.5,7.5,7.5h23.61C413.981,203.728,417.331,200.368,417.331,196.228z"
              fill="#E5D665"
            />
            <Path
              d="M409.831,188.728c4.15,0,7.5,3.35,7.5,7.5c0,4.14-3.35,7.5-7.5,7.5h-23.61
				c-4.14,0-7.5-3.36-7.5-7.5c0-4.15,3.36-7.5,7.5-7.5H409.831z"
              fill="#4D4D4D"
            />
            <Path
              d="M360.071,196.948v78.56h-93.79v-78.56H360.071z M351.421,211.218c0-4.14-3.36-7.5-7.5-7.5h-61.5
				c-4.14,0-7.5,3.36-7.5,7.5c0,4.15,3.36,7.5,7.5,7.5h61.5C348.061,218.718,351.421,215.368,351.421,211.218z"
              fill="#E8465A"
            />
            <Path
              d="M343.921,203.718c4.14,0,7.5,3.36,7.5,7.5c0,4.15-3.36,7.5-7.5,7.5h-61.5
				c-4.14,0-7.5-3.35-7.5-7.5c0-4.14,3.36-7.5,7.5-7.5H343.921z"
              fill="#4D4D4D"
            />
            <Path
              d="M251.281,213.678v45.1h-93.79v-45.1H251.281z M242.631,226.218c0-4.14-3.36-7.5-7.5-7.5h-61.49
				c-4.15,0-7.5,3.36-7.5,7.5c0,4.15,3.35,7.5,7.5,7.5h61.49C239.271,233.718,242.631,230.368,242.631,226.218z"
              fill="#E8465A"
            />
            <Path
              d="M235.131,218.718c4.14,0,7.5,3.36,7.5,7.5c0,4.15-3.36,7.5-7.5,7.5h-61.49
				c-4.15,0-7.5-3.35-7.5-7.5c0-4.14,3.35-7.5,7.5-7.5H235.131z"
              fill="#4D4D4D"
            />
            <Rect x="48.701" y="226.008" width="93.79" height="20.44" fill="#E8465A" />
            <Rect x="15.251" y="213.678" width="18.45" height="45.1" fill="#E5D665" />
          </G>
        </G>
      </G>
    </Svg>
